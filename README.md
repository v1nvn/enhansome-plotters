...
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 487 | 🐛 44 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
...
* [plotting-maps](https://github.com/piebro/plotting-maps) ⭐ 97 | 🐛 0 | 🌐 HTML | 📅 2023-12-11 - A simple web tool to create OpenStreetMap SVG maps for plotting.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,434 | 🐛 251 | 🌐 JavaScript | 📅 2026-04-09 - Node.js-based tool for optimizing SVG files.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,687 | 🐛 12 | 🌐 HTML | 📅 2026-04-01
