...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,146 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
...
* [bCNC](https://github.com/vlachoudis/bCNC) ⭐ 1,726 | 🐛 504 | 🌐 Python | 📅 2026-04-15 - Cross-platform G-code sender and CNC control software for grbl.
...
* [GRBL-Plotter](https://github.com/svenhb/GRBL-Plotter) ⭐ 848 | 🐛 25 | 🌐 C# | 📅 2026-04-15 - Plotter-optimized Windows GUI for grbl controller with SVG and DXF import, and flexible pen up/down control.
...
* [Inkcut](https://github.com/inkcut/inkcut) ⭐ 399 | 🐛 137 | 🌐 Python | 📅 2026-02-24 - Application for controlling 2D plotters, cutters, engravers, and CNC machines.
...
* [linedraw](https://github.com/LingDong-/linedraw) ⭐ 845 | 🐛 6 | 🌐 Python | 📅 2023-07-22 - Python tool to convert images to sketchy vector line drawings.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,435 | 🐛 251 | 🌐 JavaScript | 📅 2026-04-09 - Node.js-based tool for optimizing SVG files.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,693 | 🐛 11 | 🌐 HTML | 📅 2026-04-01
