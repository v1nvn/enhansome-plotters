...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,151 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
...
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,194 | 🐛 205 | 🌐 Java | 📅 2026-04-12 - Java-based grbl-compatible cross-platform G-code sender.
...
* [Inkcut](https://github.com/inkcut/inkcut) ⭐ 401 | 🐛 138 | 🌐 Python | 📅 2026-02-24 - Application for controlling 2D plotters, cutters, engravers, and CNC machines.
...
* [ln](https://github.com/fogleman/ln) ⭐ 3,364 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - Vector-based 3D renderer written in Go.
...
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 696 | 🐛 20 | 🌐 C | 📅 2026-02-27 - Converts bitmap images to vector graphics.
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 490 | 🐛 44 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,707 | 🐛 12 | 🌐 HTML | 📅 2026-04-01
