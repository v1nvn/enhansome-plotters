...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,156 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,587 | 🐛 139 | 🌐 JavaScript | 📅 2026-04-02 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,197 | 🐛 206 | 🌐 Java | 📅 2026-04-25 - Java-based grbl-compatible cross-platform G-code sender.
...
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,568 | 🐛 597 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
...
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 699 | 🐛 20 | 🌐 C | 📅 2026-02-27 - Converts bitmap images to vector graphics.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,442 | 🐛 251 | 🌐 JavaScript | 📅 2026-04-17 - Node.js-based tool for optimizing SVG files.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,731 | 🐛 13 | 🌐 HTML | 📅 2026-04-01
