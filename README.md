...
* [PlotterXY](https://github.com/jamescarruthers/PlotterXY) ⭐ 79 | 🐛 7 | 🌐 G-code | 📅 2024-07-22 - A coreXY plotter made from extrusion, 3d-printed parts, and an inexpensive 3d-printer control board.
...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,130 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,569 | 🐛 134 | 🌐 JavaScript | 📅 2026-03-12 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,183 | 🐛 203 | 🌐 Java | 📅 2026-03-25 - Java-based grbl-compatible cross-platform G-code sender.
...
* [GRBL-Plotter](https://github.com/svenhb/GRBL-Plotter) ⭐ 842 | 🐛 24 | 🌐 C# | 📅 2026-01-06 - Plotter-optimized Windows GUI for grbl controller with SVG and DXF import, and flexible pen up/down control.
...
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 692 | 🐛 20 | 🌐 C | 📅 2026-02-27 - Converts bitmap images to vector graphics.
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 484 | 🐛 43 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
...
* [vpype](https://github.com/abey79/vpype) ⭐ 879 | 🐛 60 | 🌐 Python | 📅 2026-03-26 - Plotter-focused Python-based CLI utility for generating and manipulating SVGs, including scaling and optimizing paths.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,613 | 🐛 11 | 🌐 HTML | 📅 2025-06-16
