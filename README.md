# Awesome Plotters [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
* [PlotterXY](https://github.com/jamescarruthers/PlotterXY) ⭐ 81 | 🐛 7 | 🌐 G-code | 📅 2024-07-22 - A coreXY plotter made from extrusion, 3d-printed parts, and an inexpensive 3d-printer control board.
* [Apple-410](https://github.com/phooky/Apple-410) ⭐ 29 | 🐛 1 | 🌐 Python | 📅 2025-04-29 - Apple 410 Color Plotter documentation, drivers, and ROM dumps.
* [openBrushograph](https://github.com/openBrushograph/openBrushograph_hardware) ⭐ 20 | 🐛 0 | 🌐 OpenSCAD | 📅 2025-12-13 - Open source 3d-printable XY gantry and Z-stage designed for automated brush and pen painting.
* [Lego-Pen-Plotter](https://github.com/Jormono1/Lego-Pen-Plotter) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2026-04-11 - Pen plotter built entirely of LEGO and programmed with PyBricks and Python.
...
* [PlotAdapter](https://github.com/rhalkyard/plotadapter) ⭐ 27 | 🐛 0 | 🌐 C++ | 📅 2022-05-12 - "Serial-GPIB converter for HP Plotters", uses an Arduino microcontroller to convert serial HPGL to the GPIB/HP-IB expected by some older HP plotters.
...
* [djipco/hpgl](https://github.com/djipco/hpgl) ⭐ 42 | 🐛 0 | 🌐 JavaScript | 📅 2022-12-21 - A Node.js library to communicate with HPGL-compatible plotters and printers.
* [Chiplotle](https://github.com/drepetto/chiplotle) ⭐ 38 | 🐛 7 | 🌐 Python | 📅 2021-11-06 - Python library for generating HPGL and interfacing with serial plotters.
...
* [HPGL Viewer](https://github.com/drskullster/HPGLViewer) ⭐ 22 | 🐛 7 | 🌐 JavaScript | 📅 2026-02-14 - An HPGL Viewer using JavaScript and HTML5 canvas.
* [d3-hpgl](https://github.com/aubergene/d3-hpgl) ⭐ 20 | 🐛 4 | 🌐 JavaScript | 📅 2019-09-29 - An adapter for the HTML Canvas API so you can output HPGL using the popular [D3](https://d3js.org) library.
...
* [Chiplotle3](https://github.com/cyprienh/chiplotle3) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2025-03-10 - Chiplotle fork updated for Python 3.x compatibility.
...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,159 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,588 | 🐛 139 | 🌐 JavaScript | 📅 2026-04-02 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,198 | 🐛 206 | 🌐 Java | 📅 2026-04-25 - Java-based grbl-compatible cross-platform G-code sender.
* [gcodeplot](https://github.com/arpruss/gcodeplot) ⭐ 193 | 🐛 19 | 🌐 Python | 📅 2025-04-21 - Python utility to convert SVG and HPGL to G-code for a 3-axis CNC machine.
...
* [node-gcode](https://github.com/ryansturmer/node-gcode) ⭐ 35 | 🐛 2 | 🌐 JavaScript | 📅 2016-02-04 - Node.js G-code interpreter and simulator.
* [gcode-generative-for-processing](https://github.com/o0morgan0o/gcode-generative-for-processing) ⭐ 32 | 🐛 0 | 🌐 Java | 📅 2020-02-28 - Processing library, aiming to create gcode from simple shapes. (Designed for usage with the Creality CR10)
...
* [bCNC](https://github.com/vlachoudis/bCNC) ⭐ 1,729 | 🐛 505 | 🌐 Python | 📅 2026-04-15 - Cross-platform G-code sender and CNC control software for grbl.
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,570 | 🐛 597 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
* [GRBL-Plotter](https://github.com/svenhb/GRBL-Plotter) ⭐ 850 | 🐛 26 | 🌐 C# | 📅 2026-04-15 - Plotter-optimized Windows GUI for grbl controller with SVG and DXF import, and flexible pen up/down control.
...
* [axidraw](https://github.com/evil-mad/axidraw) ⭐ 462 | 🐛 13 | 🌐 Python | 📅 2024-04-12 - Official AxiDraw extensions for Inkscape.
* [Inkcut](https://github.com/inkcut/inkcut) ⭐ 402 | 🐛 138 | 🌐 Python | 📅 2026-04-21 - Application for controlling 2D plotters, cutters, engravers, and CNC machines.
* [axi](https://github.com/fogleman/axi) ⭐ 283 | 🐛 14 | 🌐 Python | 📅 2020-02-29 - Unofficial Python library for the AxiDraw v3.
...
* [py\_silhouette](https://github.com/mossblaser/py_silhouette) ⭐ 41 | 🐛 4 | 🌐 Python | 📅 2025-11-12 - Python library for controlling Silhouette plotters and cutters.
...
* [AxiTurtle](https://github.com/ralphcrutzen/AxiTurtle) ⭐ 16 | 🐛 0 | 🌐 Processing | 📅 2018-04-25 - Turtle graphics for AxiDraw in Processing.
* [Line-us Inkscape Plugin](https://github.com/Line-us/Inkscape-Plugin) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2018-05-25 - Sends drawings to the Line-us plotter directly from Inkscape.
* [MP2300-Tools](https://github.com/Jan--Henrik/MP2300-Tools) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2023-04-06 - Software for converting HPGL to Graphtec's GPGL format, as well as CAD files for a Graphtec plotter pen adapter.
* [pypenwriter](https://github.com/Lana-chan/pypenwriter) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2024-01-27 - Python script to convert and send SVG drawings to the Panasonic PenWriter family of typewriter plotters.

### Vector Creation

Tools to create vector artwork from scratch or by conversion from other formats.

* [ln](https://github.com/fogleman/ln) ⭐ 3,366 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - Vector-based 3D renderer written in Go.
* [linedraw](https://github.com/LingDong-/linedraw) ⭐ 847 | 🐛 6 | 🌐 Python | 📅 2023-07-22 - Python tool to convert images to sketchy vector line drawings.
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 700 | 🐛 20 | 🌐 C | 📅 2026-02-27 - Converts bitmap images to vector graphics.
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 491 | 🐛 44 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
* [stipplegen](https://github.com/evil-mad/stipplegen) ⭐ 468 | 🐛 8 | 🌐 Processing | 📅 2022-04-09 - Creates interesting stippled drawings from bitmap images. ([blog post](https://www.evilmadscientist.com/2012/stipplegen2))
* [SquiggleDraw](https://github.com/gwygonik/SquiggleDraw/commits/master) ⭐ 335 | 🐛 0 | 🌐 Processing | 📅 2023-01-28 - "SquiggleDraw will create a SVG file from an image, using the brightness to change the amplitude of sine waves".
* [penplot](https://github.com/mattdesl/penplot) ⭐ 270 | 🐛 1 | 🌐 JavaScript | 📅 2018-06-08 - A development environment for plotter art in JavaScript.
* [Drawbot\_image\_to\_gcode\_v2](https://github.com/Scott-Cooper/Drawbot_image_to_gcode_v2) ⭐ 178 | 🐛 12 | 🌐 Processing | 📅 2018-05-29 - Creates G-code for use on drawbots.
* [penkit](https://github.com/paulgb/penkit) ⭐ 159 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2021-02-01 - A Python library for creating line-based SVG graphics.
* [ThreadPlotter](https://github.com/LiciaHe/threadPlotter) ⭐ 139 | 🐛 0 | 🌐 Python | 📅 2020-07-12 - "A toolkit for the design and fabrication of delicate punch needle embroidery using X-Y plotters".
...
* [blackstripes](https://github.com/fullscreennl/blackstripes-python-extensions) ⭐ 100 | 🐛 7 | 🌐 C | 📅 2022-04-27 - Turns a PNG image into a SVG line drawing.
* [plotting-maps](https://github.com/piebro/plotting-maps) ⭐ 98 | 🐛 0 | 🌐 HTML | 📅 2023-12-11 - A simple web tool to create OpenStreetMap SVG maps for plotting.
* [cozyvec](https://github.com/brubsby/cozyvec) ⭐ 74 | 🐛 5 | 🌐 JavaScript | 📅 2024-04-12 - Web/Standalone terminal environment for plotter art and tweet plots.
* [generativeExamples](https://github.com/digitalcoleman/generativeExamples) ⭐ 64 | 🐛 0 | 🌐 Processing | 📅 2018-01-11 - Example Processing code that generates plottable PDFs.
* [scribbleplot](https://github.com/bleeptrack/scribbleplot) ⭐ 50 | 🐛 0 | 🌐 Processing | 📅 2018-02-22 - Scribbly image transformations in Processing.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,449 | 🐛 252 | 🌐 JavaScript | 📅 2026-04-17 - Node.js-based tool for optimizing SVG files.
* [vpype](https://github.com/abey79/vpype) ⭐ 889 | 🐛 60 | 🌐 Python | 📅 2026-04-14 - Plotter-focused Python-based CLI utility for generating and manipulating SVGs, including scaling and optimizing paths.
...
* [Polargraph Optimizer](https://github.com/ezheidtmann/polargraph-optimizer) ⭐ 58 | 🐛 0 | 🌐 Python | 📅 2015-05-03 - Optimize drawing plan for a polargraph.
* [svgoutline](https://github.com/mossblaser/svgoutline) ⭐ 22 | 🐛 0 | 🌐 Python | 📅 2024-06-04 - Python library to extract strokes and outlines from SVGs as line segments.
...
* [hershey-fonts](https://github.com/kamalmostafa/hershey-fonts) ⭐ 88 | 🐛 3 | 🌐 C | 📅 2018-01-01 - C library and original font data for the Hershey fonts.
...
* [Roland DPX-3300 Operation Manual (GitHub)](https://github.com/sismoke/Roland-DPX-3300/blob/master/manual/DPX-3300.pdf) ⭐ 0 | 🐛 0 | 🌐 Arduino | 📅 2016-10-12
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,738 | 🐛 14 | 🌐 HTML | 📅 2026-04-01
* [awesome-generative-art](https://github.com/kosmos/awesome-generative-art) ⭐ 1,813 | 🐛 9 | 📅 2024-06-04
