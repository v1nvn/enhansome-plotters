...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,135 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,572 | 🐛 136 | 🌐 JavaScript | 📅 2026-03-30 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,185 | 🐛 204 | 🌐 Java | 📅 2026-03-29 - Java-based grbl-compatible cross-platform G-code sender.
...
* [bCNC](https://github.com/vlachoudis/bCNC) ⭐ 1,720 | 🐛 504 | 🌐 Python | 📅 2026-02-03 - Cross-platform G-code sender and CNC control software for grbl.
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,558 | 🐛 592 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
...
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 486 | 🐛 43 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,414 | 🐛 251 | 🌐 JavaScript | 📅 2026-03-25 - Node.js-based tool for optimizing SVG files.
* [vpype](https://github.com/abey79/vpype) ⭐ 881 | 🐛 62 | 🌐 Python | 📅 2026-04-01 - Plotter-focused Python-based CLI utility for generating and manipulating SVGs, including scaling and optimizing paths.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,639 | 🐛 13 | 🌐 HTML | 📅 2026-04-01
