...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,147 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
...
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,190 | 🐛 205 | 🌐 Java | 📅 2026-04-12 - Java-based grbl-compatible cross-platform G-code sender.
...
* [bCNC](https://github.com/vlachoudis/bCNC) ⭐ 1,727 | 🐛 504 | 🌐 Python | 📅 2026-04-15 - Cross-platform G-code sender and CNC control software for grbl.
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,570 | 🐛 594 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
...
* [Inkcut](https://github.com/inkcut/inkcut) ⭐ 399 | 🐛 138 | 🌐 Python | 📅 2026-02-24 - Application for controlling 2D plotters, cutters, engravers, and CNC machines.
...
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 488 | 🐛 44 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
...
* [vpype](https://github.com/abey79/vpype) ⭐ 885 | 🐛 60 | 🌐 Python | 📅 2026-04-14 - Plotter-focused Python-based CLI utility for generating and manipulating SVGs, including scaling and optimizing paths.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,697 | 🐛 11 | 🌐 HTML | 📅 2026-04-01
