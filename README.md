...
* [PlotterXY](https://github.com/jamescarruthers/PlotterXY) ⭐ 74 | 🐛 7 | 🌐 G-code | 📅 2024-07-22 - A coreXY plotter made from extrusion, 3d-printed parts, and an inexpensive 3d-printer control board.
...
* [TinyG](https://github.com/synthetos/TinyG) ⭐ 939 | 🐛 71 | 🌐 G-code | 📅 2025-09-06 - More featureful and robust 6-axis G-code-based motion control hardware. ([adafruit](https://www.adafruit.com/product/1749))
...
* [djipco/hpgl](https://github.com/djipco/hpgl) ⭐ 41 | 🐛 0 | 🌐 JavaScript | 📅 2022-12-21 - A Node.js library to communicate with HPGL-compatible plotters and printers.
...
* [HPGL Viewer](https://github.com/drskullster/HPGLViewer) ⭐ 21 | 🐛 6 | 🌐 JavaScript | 📅 2026-01-01 - An HPGL Viewer using JavaScript and HTML5 canvas.
...
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,529 | 🐛 195 | 🌐 JavaScript | 📅 2026-02-01 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,157 | 🐛 203 | 🌐 Java | 📅 2026-02-05 - Java-based grbl-compatible cross-platform G-code sender.
...
* [bCNC](https://github.com/vlachoudis/bCNC) ⭐ 1,699 | 🐛 504 | 🌐 Python | 📅 2026-02-03 - Cross-platform G-code sender and CNC control software for grbl.
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,525 | 🐛 574 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
...
* [axidraw](https://github.com/evil-mad/axidraw) ⭐ 456 | 🐛 12 | 🌐 Python | 📅 2024-04-12 - Official AxiDraw extensions for Inkscape.
* [Inkcut](https://github.com/inkcut/inkcut) ⭐ 390 | 🐛 138 | 🌐 Python | 📅 2025-10-22 - Application for controlling 2D plotters, cutters, engravers, and CNC machines.
* [axi](https://github.com/fogleman/axi) ⭐ 282 | 🐛 14 | 🌐 Python | 📅 2020-02-29 - Unofficial Python library for the AxiDraw v3.
...
* [py\_silhouette](https://github.com/mossblaser/py_silhouette) ⭐ 39 | 🐛 3 | 🌐 Python | 📅 2025-11-12 - Python library for controlling Silhouette plotters and cutters.
...
* [ln](https://github.com/fogleman/ln) ⭐ 3,353 | 🐛 12 | 🌐 Go | 📅 2019-07-19 - Vector-based 3D renderer written in Go.
* [linedraw](https://github.com/LingDong-/linedraw) ⭐ 836 | 🐛 6 | 🌐 Python | 📅 2023-07-22 - Python tool to convert images to sketchy vector line drawings.
* [autotrace](https://github.com/autotrace/autotrace) ⭐ 673 | 🐛 20 | 🌐 C | 📅 2026-01-16 - Converts bitmap images to vector graphics.
* [DrawingBotV3](https://github.com/SonarSonic/DrawingBotV3) ⭐ 471 | 🐛 39 | 🌐 Java | 📅 2025-10-08 - Cross-platform software for converting images to line drawings.
...
* [penkit](https://github.com/paulgb/penkit) ⭐ 158 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2021-02-01 - A Python library for creating line-based SVG graphics.
...
* [plotting-maps](https://github.com/piebro/plotting-maps) ⭐ 89 | 🐛 0 | 🌐 HTML | 📅 2023-12-11 - A simple web tool to create OpenStreetMap SVG maps for plotting.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,293 | 🐛 260 | 🌐 JavaScript | 📅 2026-01-01 - Node.js-based tool for optimizing SVG files.
* [vpype](https://github.com/abey79/vpype) ⭐ 864 | 🐛 59 | 🌐 Python | 📅 2026-02-02 - Plotter-focused Python-based CLI utility for generating and manipulating SVGs, including scaling and optimizing paths.
...
* [penkit-optimize](https://github.com/paulgb/penkit/tree/master/optimizer) ⭐ 158 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2021-02-01 - An SVG optimizer that uses a vehicle routing solver to minimize plot time.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,409 | 🐛 7 | 🌐 HTML | 📅 2025-06-16
