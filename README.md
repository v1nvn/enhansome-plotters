...
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,555 | 🐛 196 | 🌐 JavaScript | 📅 2026-03-08 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
...
* [stipplegen](https://github.com/evil-mad/stipplegen) ⭐ 465 | 🐛 8 | 🌐 Processing | 📅 2022-04-09 - Creates interesting stippled drawings from bitmap images. ([blog post](https://www.evilmadscientist.com/2012/stipplegen2))
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,360 | 🐛 257 | 🌐 JavaScript | 📅 2026-03-08 - Node.js-based tool for optimizing SVG files.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,555 | 🐛 6 | 🌐 HTML | 📅 2025-06-16
