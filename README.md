...
* [cncjs](https://github.com/cncjs/cncjs) ⭐ 2,564 | 🐛 134 | 🌐 JavaScript | 📅 2026-03-12 - A web-based interface controlling CNC machines running grbl, TinyG, or other G-code-based firmware.
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,179 | 🐛 203 | 🌐 Java | 📅 2026-03-22 - Java-based grbl-compatible cross-platform G-code sender.
...
* [LaserGRBL](https://github.com/arkypita/LaserGRBL) ⭐ 1,550 | 🐛 589 | 🌐 C# | 📅 2025-05-29 - Laser-optimized Windows GUI for grbl controllers. Could be repurposed for DIY pen plotters that use a solenoid for pen up/down movements.
...
* [stipplegen](https://github.com/evil-mad/stipplegen) ⭐ 466 | 🐛 8 | 🌐 Processing | 📅 2022-04-09 - Creates interesting stippled drawings from bitmap images. ([blog post](https://www.evilmadscientist.com/2012/stipplegen2))
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,403 | 🐛 251 | 🌐 JavaScript | 📅 2026-03-20 - Node.js-based tool for optimizing SVG files.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,600 | 🐛 11 | 🌐 HTML | 📅 2025-06-16
