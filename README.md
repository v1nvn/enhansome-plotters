...
* [grbl](https://github.com/grbl/grbl) ⭐ 6,140 | 🐛 564 | 🌐 C | 📅 2024-06-02 - A high-performance G-code interpreting firmware for the Atmega 328 microcontroller and Arduino.
...
* [Universal-G-Code-Sender](https://github.com/winder/Universal-G-Code-Sender) ⭐ 2,187 | 🐛 204 | 🌐 Java | 📅 2026-04-07 - Java-based grbl-compatible cross-platform G-code sender.
...
* [GRBL-Plotter](https://github.com/svenhb/GRBL-Plotter) ⭐ 848 | 🐛 25 | 🌐 C# | 📅 2026-01-06 - Plotter-optimized Windows GUI for grbl controller with SVG and DXF import, and flexible pen up/down control.
...
* [svgo](https://github.com/svg/svgo) ⭐ 22,427 | 🐛 251 | 🌐 JavaScript | 📅 2026-04-09 - Node.js-based tool for optimizing SVG files.
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 14,661 | 🐛 12 | 🌐 HTML | 📅 2026-04-01
